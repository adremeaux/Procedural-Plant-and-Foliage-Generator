...
namespace BionicWombat {
  ...
  public class PlantTrunk : IStem {
    ...
    public void CreateCurves(LeafParamDict fields, LeafDeps deps, ArrangementData arr, FlowerPotController potController) {
      curves = new List<Curve3D>();
      shape = CreateShape(fields, deps);
      ...
      curves.Add(main);
      linearPoints = LeafVeins.CalcLinearPoints(curves, deps);
    }

    private static Vector3[] CreateShape(LeafParamDict fields, LeafDeps deps) {
