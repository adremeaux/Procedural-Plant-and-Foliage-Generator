...
public class DistortionCurve {
  ...
  private Curve3D[] influenceCurves;
  ...
  public DistortionCurve(LeafDeps deps, Curve3D influenceCurve, Curve3D distortionCurve, DistCurveConfig config) :
    this(deps, new Curve3D[] { influenceCurve }, CreatePointsFromCurve(distortionCurve), config) { }

  public DistortionCurve(LeafDeps deps, Curve3D influenceCurve, Vector3[] distortionPoints, DistCurveConfig config) :
    this(deps, new Curve3D[] { influenceCurve }, distortionPoints, config) { }

  public DistortionCurve(LeafDeps deps, Curve3D[] influenceCurves, Vector3[] distortionPoints, DistCurveConfig config) {
  ...
  public DistortionCurve Copy() => new DistortionCurve(deps, influenceCurves, distortionPoints, config);

  public DistortionCurve Transform(Transform t) {
    if (t == null) return Copy();
    DistortionCurve d = new DistortionCurve(deps, influenceCurves, distortionPoints, config);
